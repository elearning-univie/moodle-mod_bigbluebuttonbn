...
$string['config_waitformoderator_waitingroom_description'] = 'If checked the moderator must grant the viewer access to the room.';
...
$string['config_participants_rights_enableviewerswebcams_description'] = 'Restricts viewer\'s ability to share their webcams.';
$string['config_participants_rights_seeviewerswebcams'] = 'See other viewers webcams';
$string['config_participants_rights_seeviewerswebcams_description'] = 'When enabled, only the moderator\'s incoming webcam will be visible to viewers, while all viewers\' webcams are still visible to the moderator - this setting also reduces the bandwidth for individual viewers.';
$string['config_participants_rights_enablemic'] = 'Share microphone';
$string['config_participants_rights_enablemic_description'] = 'Restricts a viewer\'s ability to share their mic. If there are already mics joined in the session when this lock setting is applied, all joined mics will be automatically muted and locked restricting a viewer\'s ability to unmute.';
$string['config_participants_rights_enablepublicchat'] = 'Send public chat messages';
$string['config_participants_rights_enablepublicchat_description'] = 'Restricts viewer\'s ability to post to the public chat.';
$string['config_participants_rights_enableprivatechat'] = 'Send private chat messages';
$string['config_participants_rights_enableprivatechat_description'] = 'Restricts viewer\'s ability to send private chat messages to other viewers unless a moderator sends a private chat. Viewers can reply to private chat messages from moderators when the private chat is locked.';
$string['config_participants_rights_enablenotes'] = 'Edit shared notes';
$string['config_participants_rights_enablenotes_description'] = 'Restricts viewer\'s ability to open and contribute to the shared notes.';
$string['config_participants_rights_visibleuserlist'] = 'See other viewers in the users list';
$string['config_participants_rights_visibleuserlist_description'] = 'Restricts viewer\'s ability to see other attendees/number of attendees in the users list. When enabled, viewers will only see their own users icon and the moderator.';
...
$string['mod_form_block_guestlink'] = 'External guest access link';
...
$string['mod_form_field_waitingroom'] = 'Waiting room (Approval by the moderator must be gratned before entering the room.)';
