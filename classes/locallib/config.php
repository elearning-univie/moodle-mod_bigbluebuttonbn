...
class config {
    ...
    public static function defaultvalues() {
        return array(
            ...
            'waitformoderator_waitingroom' => true,
            'userlimit_default' => '0',
            ...
            'participants_rights' => '1',
            'participants_rights_enableviewerswebcams' => 1,
            'participants_rights_seeviewerswebcams' => 1,
            'participants_rights_enablemic' => 1,
            'participants_rights_enablepublicchat' => 1,
            'participants_rights_enableprivatechat' => 1,
            'participants_rights_enablenotes' => 1,
            'participants_rights_visibleuserlist' => 1,
            'custom_logo' => '',
    ...
    public static function get_options() {
        return array(
               ...
               'waitformoderator_waitingroom' => (boolean)self::get('waitformoderator_waitingroom'),
               ...
               'participants_rights_enableviewerswebcams' => (boolean)self::get('participants_rights_enableviewerswebcams'),
               'participants_rights_seeviewerswebcams' => (boolean)self::get('participants_rights_seeviewerswebcams'),
               'participants_rights_enablemic' => (boolean)self::get('participants_rights_enablemic'),
               'participants_rights_enablepublicchat' => (boolean)self::get('participants_rights_enablepublicchat'),
               'participants_rights_enableprivatechat' => (boolean)self::get('participants_rights_enableprivatechat'),
               'participants_rights_enablenotes' => (boolean)self::get('participants_rights_enablenotes'),
               'participants_rights_visibleuserlist' => (boolean)self::get('participants_rights_visibleuserlist'),
            );
    }
}
